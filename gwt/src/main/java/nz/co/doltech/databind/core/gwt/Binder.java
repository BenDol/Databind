...
import nz.co.doltech.databind.core.propertyadapters.ObjectAsValuePropertyAdapter;
 ...
 * Binder.bind(personListBox, "selectedPerson.category").mode(Mode.OneWay).to(categoryForm, "$ModelMap");
 *
