...
class ClazzInfoBuilder {
    ...
    public String buildClassInfoFor(JClassType reflectedType) {
        ...
        if (reflectedTypeName.equals("com.google.gwt.core.client.JavaScriptObject"))
            return "nz.co.doltech.databind.classinfo.gwt.internal.JavaScriptObjectClazz";
        if (reflectedTypeName.equals("java.lang.Object"))
            return "nz.co.doltech.databind.classinfo.internal.ObjectClazz";
    ...
    private void buildClassInfo() {
        ...
        composer.setSuperclass("nz.co.doltech.databind.classinfo.internal.ClazzBase<" + reflectedTypeName + ">");
        composer.addImport("java.util.List");
        composer.addImport("java.util.ArrayList");
        composer.addImport("nz.co.doltech.databind.classinfo.Field");
        composer.addImport("nz.co.doltech.databind.classinfo.Method");
    ...
    private void buildClassInfo(SourceWriter sourceWriter) {
        ...
        sourceWriter.println("protected void ensureSuperClassRegistered()");
        sourceWriter.println("{");
        sourceWriter.indent();
        if (superclassGeneratedClazz != null)
            sourceWriter.println("nz.co.doltech.databind.classinfo.ClassInfo.registerClazz( new " + superclassGeneratedClazz + "() );");
        sourceWriter.outdent();
        sourceWriter.println("}");
        sourceWriter.println("");
    ...
    private void buildFieldClass(JField field, SourceWriter sourceWriter) {
        ...
        sourceWriter.println("static class " + fieldClassName + " extends nz.co.doltech.databind.classinfo.internal.FieldBase {");
        sourceWriter.indent();
    ...
    private void generateMethodClass(String methodClassName, JMethod method, SourceWriter sourceWriter) {
        ...
        sourceWriter.println("static class " + methodClassName + " extends nz.co.doltech.databind.classinfo.internal.MethodBase {");
        sourceWriter.indent();
