...
import nz.co.doltech.databinder.databinding.propertyadapters.ObjectAsValuePropertyAdapter;
...
public class Binder {
     ...
     * First step, accepts a data binding source definition and creates a binder
     *
     * @param widget The HasValue widget, like a TextBox. The binding system will
     ...
     * First step, accepts a data binding source definition and creates a binder
     *
     * @param listBox The ListBox widget, like a TextBox. The binding system will
     ...
     * First step, accepts a data binding source definition and creates a binder
     *
     * @param source Accepts a source object as the value provided for the binding.
