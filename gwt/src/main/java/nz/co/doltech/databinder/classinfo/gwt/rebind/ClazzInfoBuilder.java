...
import nz.co.doltech.databinder.classinfo.IgnoreInfo;
import nz.co.doltech.databinder.classinfo.gwt.TypeHelper;
...
class ClazzInfoBuilder {
    ...
    public String buildClassInfoFor(JClassType reflectedType) {
        ...
        if (reflectedTypeName.equals("com.google.gwt.core.client.JavaScriptObject"))
            return "nz.co.doltech.databinder.classinfo.gwt.internal.JavaScriptObjectClazz";
        if (reflectedTypeName.equals("java.lang.Object"))
            return "nz.co.doltech.databinder.classinfo.internal.ObjectClazz";
    ...
    private void buildClassInfo() {
        ...
        composer.setSuperclass("nz.co.doltech.databinder.classinfo.internal.ClazzBase<" + reflectedTypeName + ">");
        composer.addImport("java.util.List");
        composer.addImport("java.util.ArrayList");
        composer.addImport("nz.co.doltech.databinder.classinfo.Field");
        composer.addImport("nz.co.doltech.databinder.classinfo.Method");
    ...
    private void buildClassInfo(SourceWriter sourceWriter) {
        ...
        if (superclassGeneratedClazz != null)
            sourceWriter.println("nz.co.doltech.databinder.classinfo.ClassInfo.RegisterClazz( new " + superclassGeneratedClazz + "() );");
        sourceWriter.outdent();
        sourceWriter.println("}");
        sourceWriter.println("");
    ...
    private void buildFieldClass(JField field, SourceWriter sourceWriter) {
        ...
        sourceWriter.println("static class " + fieldClassName + " extends nz.co.doltech.databinder.classinfo.internal.FieldBase {");
        sourceWriter.indent();
    ...
    private void generateMethodClass(String methodClassName, JMethod method, SourceWriter sourceWriter) {
        ...
        sourceWriter.println("static class " + methodClassName + " extends nz.co.doltech.databinder.classinfo.internal.MethodBase {");
        sourceWriter.indent();
