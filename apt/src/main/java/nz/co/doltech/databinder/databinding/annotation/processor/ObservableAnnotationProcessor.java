...
import nz.co.doltech.databinder.util.StringUtils;
...
import static nz.co.doltech.databinder.databinding.annotation.processor.Tags.*;

@SupportedAnnotationTypes({"nz.co.doltech.databinder.databinding.annotation.Observable"})
...
public class ObservableAnnotationProcessor extends BaseAnnotationProcessor {
    ...
    private static final String TEMPLATE_CLASS = "nz/co/doltech/databinder/databinding/annotation/processor/TemplateClass.txt";
