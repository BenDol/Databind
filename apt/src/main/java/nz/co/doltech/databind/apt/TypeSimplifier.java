...
final public class TypeSimplifier {
     ...
     */
    public static String getTypeQualifiedName(TypeMirror type) throws IllegalStateException {
        if (type.toString().equals("<any>")) {
            throw new IllegalStateException("Type reported as <any> is likely a not-yet " +
