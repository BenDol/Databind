...
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.DOUBLE_OBJECT;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.DOUBLE_PRIMITIVE;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.FLOAT_OBJECT;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.FLOAT_PRIMITIVE;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.INT_OBJECT;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.INT_PRIMITIVE;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.LONG_OBJECT;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.LONG_PRIMITIVE;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.SHORT_OBJECT;
import static nz.co.doltech.databind.apt.reflect.gwt.javaparser.JavaType.SHORT_PRIMITIVE;
...
public final class JdkJavaType {
    ...
    public static boolean isPartOfJavaLang(final String simpleTypeName) {
        Validate.notEmpty(simpleTypeName, "Simple type name required");
