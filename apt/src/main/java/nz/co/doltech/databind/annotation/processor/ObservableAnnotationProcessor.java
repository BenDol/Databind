...
@SupportedAnnotationTypes({"nz.co.doltech.databind.annotation.Observable"})
...
public class ObservableAnnotationProcessor extends BaseAnnotationProcessor {
    ...
    private static final String TEMPLATE_CLASS = "nz/co/doltech/databind/annotation/processor/TemplateClass.txt";
